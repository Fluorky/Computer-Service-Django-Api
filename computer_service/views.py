...
def index(request):
    ...
    return render(request, 'computer_service/index.html') 

def service_request_list(request):
    service_requests = ServiceRequest.objects.all()
    return render(request, 'computer_service/service_request_list.html', {'service_requests': service_requests})

def service_request_detail(request, pk):
    service_request = get_object_or_404(ServiceRequest, pk=pk)
    return render(request, 'computer_service/service_request_detail.html', {'service_request': service_request})
...
def service_request_delete(request, pk):
    ...
    return render(request, 'computer_service/service_request_confirm_delete.html', {'service_request': service_request})


def invoice_list(request):
    invoices = Invoice.objects.all()
    return render(request, 'computer_service/invoice_list.html', {'invoices': invoices})


def invoice_detail(request, pk):
    invoice = get_object_or_404(Invoice, pk=pk)
    return render(request, 'computer_service/invoice_detail.html', {'invoice': invoice})
...
def invoice_delete(request, pk):
    ...
    return render(request, 'computer_service/invoice_confirm_delete.html', {'invoice': invoice})


def part_list(request):
    parts = Part.objects.all()
    return render(request, 'computer_service/part_list.html', {'parts': parts})

def part_detail(request, pk):
    part = get_object_or_404(Part, pk=pk)
    return render(request, 'computer_service/part_detail.html', {'part': part})
...
def part_delete(request, pk):
    ...
    return render(request, 'computer_service/part_confirm_delete.html', {'part': part})


def service_technician_list(request):
    service_technicians = ServiceTechnician.objects.all()
    return render(request, 'computer_service/service_technician_list.html', {'service_technicians': service_technicians})

def service_technician_detail(request, pk):
    service_technician = get_object_or_404(ServiceTechnician, pk=pk)
    return render(request, 'computer_service/service_technician_detail.html', {'service_technician': service_technician})
...
def service_technician_delete(request, pk):
    ...
    return render(request, 'computer_service/service_technician_confirm_delete.html', {'service_technician': service_technician})


def customer_list(request):
    customers = Customer.objects.all()
    return render(request, 'computer_service/customer_list.html', {'customers': customers})

def customer_detail(request, pk):
    customer = get_object_or_404(Customer, pk=pk)
    return render(request, 'computer_service/customer_detail.html', {'customer': customer})
...
def customer_delete(request, pk):
    ...
    return render(request, 'computer_service/customer_confirm_delete.html', {'customer': customer})
##TO DO##
